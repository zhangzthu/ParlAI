...
from parlai.mturk.tasks.dialog_eval_nego.worlds import \
    DialogEvalNegoOnboardWorld, DialogEvalNegoWorld
from parlai.mturk.core.mturk_manager import MTurkManager
from parlai.mturk.tasks.dialog_eval_nego.task_config import task_config
import os
import importlib
...
def main():
    ...
    def run_onboard(worker):
        world = DialogEvalNegoOnboardWorld(opt=opt, mturk_agent=worker)
